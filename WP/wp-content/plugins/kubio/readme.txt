...
-   **Row** - Add a new row to the website canvas, then add blocks to it. Make adjustments to its columns, spacing, typography, background, and more.
...
-   **Image Gallery** - Create appealing image galleries and customize their number of columns, the image size, click behavior, and more.
-   **Shortcode** - Use shortcodes to insert various forms, galleries, tables, and more, depending on the plugins you use.
-   **Map** - Embed Google Maps, insert your desired address, adjust zoom, height, and hover behavior.
...
-   **Counter** - Show off various stats on your website using animated Counter block for Gutenberg.
