...
class MenuItemsBlock extends BlockBase {
	...
	public function renderMenu() {
		...
		if ( ! $this->isForcedOnlyFirstLevel() ) {
			...
			add_filter( 'nav_menu_css_class', array( $this, 'fixCSSClasses' ), 2, 4 );
			// add_filter( 'page_menu_link_attributes', array( $this, 'fixCSSClasses' ), 2, 4 );
		...
		if ( ! $this->isForcedOnlyFirstLevel() ) {
			remove_filter( 'nav_menu_item_args', array( $this, 'addParentMenuItemsIcon' ), 2 );
			remove_filter( 'nav_menu_css_class', array( $this, 'fixCSSClasses' ), 2 );
			// remove_filter( 'page_menu_link_attributes', array( $this, 'fixCSSClasses' ), 2 );
		}
